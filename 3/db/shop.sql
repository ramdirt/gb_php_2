...
--
-- Хост: localhost
-- Время создания: Апр 15 2022 г., 15:03
...
INSERT INTO `products` (`id`, `category_id`, `title`, `price`, `description`) VALUES
(71, 1, 'name', 125, 'description'),
(72, 1, 'name', 125, 'description'),
(73, 1, 'name', 125, 'description'),
(74, 1, 'name', 125, 'description'),
(76, 1, 'name', 125, 'description'),
(77, 1, 'name', 125, 'description'),
(78, 1, 'name', 125, 'description'),
(79, 1, 'name', 125, 'description'),
(89, 1, 'name', 125, 'description'),
(90, 1, 'name', 125, 'description'),
(91, 1, 'name', 125, 'description'),
(92, 1, 'name', 125, 'description'),
(93, 1, 'name', 125, 'description'),
(94, 1, 'name', 125, 'description'),
(95, 1, 'name', 125, 'description'),
(96, 1, 'name', 125, 'description'),
(97, 1, 'name', 125, 'description');
